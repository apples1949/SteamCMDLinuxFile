# SteamCMDLinuxFile
通过白嫖github下载更新好的steamcmd程序。需要的人自行参考以下指令下载，或者复刻仓库自己优化。针对steamcmd优化了压缩文件。如果steamcmd变更了文件结构说一声。下载链接最好是获取第三方加速链接 https://github.com/xiaoxuan6/github-mirror 或者通过更改UA下载[gitee加速源](https://gitee.com/apples1949/SteamCMDLinuxFile) 保不齐哪天寄了  
常用指令:  
```
mkdir steamcmd
```
